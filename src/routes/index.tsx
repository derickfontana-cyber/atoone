...
function Home() {
  ...
  return <main>
    ...
    <section className="cta-band" id="contact"><div className="cta-orb"><Asterisk/></div><span className="kicker light">Comece com uma conversa</span><h2>Sua próxima contratação<br/>pode ser um <em>fluxo de trabalho.</em></h2><p>Em 30 minutos, descobrimos onde a automação pode gerar mais impacto no seu negócio. Sem pressão de venda. Apenas ideias úteis.</p><a href="mailto:hello@relayautomation.co?subject=An%C3%A1lise%20gratuita%20de%20automa%C3%A7%C3%A3o" className="button cream">Agende sua análise gratuita <ArrowRight size={18}/></a></section>
    <footer className="footer"><a className="brand" href="#top"><span className="brand-mark"><Asterisk size={19}/></span>RELAY</a><p>Sistemas inteligentes para negócios humanos.</p><div><a href="#services">Serviços</a><a href="#process">Processo</a><a href="mailto:hello@relayautomation.co">Contato</a></div><small>© 2026 Relay Automation Studio</small></footer>
  </main>
}
